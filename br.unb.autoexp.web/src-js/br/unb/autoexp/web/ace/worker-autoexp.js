...
define('ace/mode/autoexp_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/autoexp/autoexpparse'], function(require, exports, module) {

	var oop = require("../lib/oop");
	var Mirror = require("../worker/mirror").Mirror;
	var autoexpparse = require("../mode/autoexp/autoexpparse");
	
	importScripts("../parser/antlr-all-min.js");
	importScripts("../parser/AutoExpLexer.js");
	importScripts("../parser/AutoExpParser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new AutoExpLexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new AutoExpParser(tstream);
		    try {
		    	parser.rule_Model();
		    } catch(err) {
...
define('ace/mode/autoexp/autoexpparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'autoexpparse', function (exports) {
