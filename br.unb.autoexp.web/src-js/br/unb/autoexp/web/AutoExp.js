 ...
 */
(function() {
	rap.registerTypeHandler("br.unb.autoexp.web.editor.widget.AutoExp", {
		factory : function(properties) {
			return new br.unb.autoexp.web.editor.widget.AutoExp(properties);
		},
		destructor : "destroy",
	...
	rwt.qx.Class.define("br.unb.autoexp.web.editor.widget.AutoExp", {
		...
		members : {
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/br/unb/autoexp/web/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/br/unb/autoexp/web/ace';
				ace.require("ace/config").set("themePath", themePath);
				var modePath = 'rwt-resources/src-js/br/unb/autoexp/web/ace';
				...
				if (editor != null) {
					...
					ace.config.loadModule("ace/ext/language_tools", function (module) {
						editor.getSession().setMode("ace/mode/autoexp");
						...
						editor.setTheme("ace/theme/autoexp");
