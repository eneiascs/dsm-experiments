		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExperimentalDesignAccess().getGroup_8_3(), "rule__ExperimentalDesign__Group_8_3__0");
					put(grammarAccess.getExperimentalDesignAccess().getGroup_12(), "rule__ExperimentalDesign__Group_12__0");
					put(grammarAccess.getExperimentalDesignAccess().getGroup_17(), "rule__ExperimentalDesign__Group_17__0");
					put(grammarAccess.getExperimentalDesignAccess().getGroup_19(), "rule__ExperimentalDesign__Group_19__0");
					put(grammarAccess.getExperimentalDesignAccess().getGroup_19_3(), "rule__ExperimentalDesign__Group_19_3__0");
					put(grammarAccess.getExperimentalDesignAccess().getGroup_23(), "rule__ExperimentalDesign__Group_23__0");
					...
					put(grammarAccess.getExperimentalDesignAccess().getGroup_26(), "rule__ExperimentalDesign__Group_26__0");
					put(grammarAccess.getExperimentalDesignAccess().getGroup_26_3(), "rule__ExperimentalDesign__Group_26_3__0");
					...
					put(grammarAccess.getExperimentalDesignAccess().getInstrumentsAssignment_8_2(), "rule__ExperimentalDesign__InstrumentsAssignment_8_2");
					put(grammarAccess.getExperimentalDesignAccess().getInstrumentsAssignment_8_3_1(), "rule__ExperimentalDesign__InstrumentsAssignment_8_3_1");
					put(grammarAccess.getExperimentalDesignAccess().getFactorsAssignment_11(), "rule__ExperimentalDesign__FactorsAssignment_11");
					put(grammarAccess.getExperimentalDesignAccess().getFactorsAssignment_12_1(), "rule__ExperimentalDesign__FactorsAssignment_12_1");
					put(grammarAccess.getExperimentalDesignAccess().getTreatmentsAssignment_16(), "rule__ExperimentalDesign__TreatmentsAssignment_16");
					put(grammarAccess.getExperimentalDesignAccess().getTreatmentsAssignment_17_1(), "rule__ExperimentalDesign__TreatmentsAssignment_17_1");
					put(grammarAccess.getExperimentalDesignAccess().getGroupsAssignment_19_2(), "rule__ExperimentalDesign__GroupsAssignment_19_2");
					put(grammarAccess.getExperimentalDesignAccess().getGroupsAssignment_19_3_1(), "rule__ExperimentalDesign__GroupsAssignment_19_3_1");
					put(grammarAccess.getExperimentalDesignAccess().getExperimentalObjectsAssignment_22(), "rule__ExperimentalDesign__ExperimentalObjectsAssignment_22");
					put(grammarAccess.getExperimentalDesignAccess().getExperimentalObjectsAssignment_23_1(), "rule__ExperimentalDesign__ExperimentalObjectsAssignment_23_1");
					put(grammarAccess.getExperimentalDesignAccess().getRestrictionsAssignment_25_2(), "rule__ExperimentalDesign__RestrictionsAssignment_25_2");
					put(grammarAccess.getExperimentalDesignAccess().getRestrictionsAssignment_25_3_1(), "rule__ExperimentalDesign__RestrictionsAssignment_25_3_1");
					put(grammarAccess.getExperimentalDesignAccess().getContextVariablesAssignment_26_2(), "rule__ExperimentalDesign__ContextVariablesAssignment_26_2");
					put(grammarAccess.getExperimentalDesignAccess().getContextVariablesAssignment_26_3_1(), "rule__ExperimentalDesign__ContextVariablesAssignment_26_3_1");
