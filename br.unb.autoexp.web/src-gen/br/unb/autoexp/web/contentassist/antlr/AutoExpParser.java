		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExperimentAccess().getGroup_38(), "rule__Experiment__Group_38__0");
					put(grammarAccess.getExperimentAccess().getGroup_44(), "rule__Experiment__Group_44__0");
					put(grammarAccess.getExperimentAccess().getGroup_46(), "rule__Experiment__Group_46__0");
					...
					put(grammarAccess.getExecutionAccess().getGroup_7(), "rule__Execution__Group_7__0");
					put(grammarAccess.getExecutionAccess().getGroup_7_3(), "rule__Execution__Group_7_3__0");
					put(grammarAccess.getExecutionAccess().getGroup_8(), "rule__Execution__Group_8__0");
					put(grammarAccess.getExecutionAccess().getGroup_8_3(), "rule__Execution__Group_8_3__0");
					...
					put(grammarAccess.getExperimentalObjectAccess().getGroup_7(), "rule__ExperimentalObject__Group_7__0");
					put(grammarAccess.getExperimentalObjectAccess().getGroup_7_3(), "rule__ExperimentalObject__Group_7_3__0");
					put(grammarAccess.getExperimentalObjectAccess().getGroup_8(), "rule__ExperimentalObject__Group_8__0");
					put(grammarAccess.getExperimentalObjectAccess().getGroup_8_3(), "rule__ExperimentalObject__Group_8_3__0");
					...
					put(grammarAccess.getDependentVariableAccess().getGroup_5(), "rule__DependentVariable__Group_5__0");
					put(grammarAccess.getDependentVariableAccess().getGroup_6(), "rule__DependentVariable__Group_6__0");
					put(grammarAccess.getDependentVariableAccess().getGroup_7(), "rule__DependentVariable__Group_7__0");
					put(grammarAccess.getDependentVariableAccess().getGroup_7_3(), "rule__DependentVariable__Group_7_3__0");
					put(grammarAccess.getDependentVariableAccess().getGroup_8(), "rule__DependentVariable__Group_8__0");
					...
					put(grammarAccess.getExperimentAccess().getObjectsDescriptionAssignment_33(), "rule__Experiment__ObjectsDescriptionAssignment_33");
					put(grammarAccess.getExperimentAccess().getObjectsScaleTypeAssignment_35(), "rule__Experiment__ObjectsScaleTypeAssignment_35");
					put(grammarAccess.getExperimentAccess().getExperimentalObjectsAssignment_37(), "rule__Experiment__ExperimentalObjectsAssignment_37");
					put(grammarAccess.getExperimentAccess().getExperimentalObjectsAssignment_38_1(), "rule__Experiment__ExperimentalObjectsAssignment_38_1");
					put(grammarAccess.getExperimentAccess().getExecutionsAssignment_43(), "rule__Experiment__ExecutionsAssignment_43");
					put(grammarAccess.getExperimentAccess().getExecutionsAssignment_44_1(), "rule__Experiment__ExecutionsAssignment_44_1");
					put(grammarAccess.getExperimentAccess().getAnalysisAssignment_46_1(), "rule__Experiment__AnalysisAssignment_46_1");
					put(grammarAccess.getExperimentAccess().getInfrastructureAssignment_48(), "rule__Experiment__InfrastructureAssignment_48");
					...
					put(grammarAccess.getExecutionAccess().getPreProcessingExecutionsAssignment_7_2(), "rule__Execution__PreProcessingExecutionsAssignment_7_2");
					put(grammarAccess.getExecutionAccess().getPreProcessingExecutionsAssignment_7_3_1(), "rule__Execution__PreProcessingExecutionsAssignment_7_3_1");
					put(grammarAccess.getExecutionAccess().getPostProcessingExecutionsAssignment_8_2(), "rule__Execution__PostProcessingExecutionsAssignment_8_2");
					put(grammarAccess.getExecutionAccess().getPostProcessingExecutionsAssignment_8_3_1(), "rule__Execution__PostProcessingExecutionsAssignment_8_3_1");
					...
					put(grammarAccess.getExperimentalObjectAccess().getDescriptionAssignment_4(), "rule__ExperimentalObject__DescriptionAssignment_4");
					put(grammarAccess.getExperimentalObjectAccess().getValueAssignment_5_1(), "rule__ExperimentalObject__ValueAssignment_5_1");
					put(grammarAccess.getExperimentalObjectAccess().getObjectGroupAssignment_6_1(), "rule__ExperimentalObject__ObjectGroupAssignment_6_1");
					put(grammarAccess.getExperimentalObjectAccess().getParametersAssignment_7_2(), "rule__ExperimentalObject__ParametersAssignment_7_2");
					put(grammarAccess.getExperimentalObjectAccess().getParametersAssignment_7_3_1(), "rule__ExperimentalObject__ParametersAssignment_7_3_1");
					put(grammarAccess.getExperimentalObjectAccess().getFilesAssignment_8_2(), "rule__ExperimentalObject__FilesAssignment_8_2");
					put(grammarAccess.getExperimentalObjectAccess().getFilesAssignment_8_3_1(), "rule__ExperimentalObject__FilesAssignment_8_3_1");
					...
					put(grammarAccess.getDependentVariableAccess().getDescriptionAssignment_4(), "rule__DependentVariable__DescriptionAssignment_4");
					put(grammarAccess.getDependentVariableAccess().getScaleTypeAssignment_5_1(), "rule__DependentVariable__ScaleTypeAssignment_5_1");
					put(grammarAccess.getDependentVariableAccess().getUnitAssignment_6_1(), "rule__DependentVariable__UnitAssignment_6_1");
					put(grammarAccess.getDependentVariableAccess().getRangeAssignment_7_2(), "rule__DependentVariable__RangeAssignment_7_2");
					put(grammarAccess.getDependentVariableAccess().getRangeAssignment_7_3_1(), "rule__DependentVariable__RangeAssignment_7_3_1");
					put(grammarAccess.getDependentVariableAccess().getInstrumentAssignment_8_1(), "rule__DependentVariable__InstrumentAssignment_8_1");
