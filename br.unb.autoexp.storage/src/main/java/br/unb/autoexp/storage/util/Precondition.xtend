package br.unb.autoexp.storage.util
/**
...
final class Precondition {
     ...
     */
   def static void isTrue(boolean expression, String errorMessageTemplate, Object... errorMessageArguments) {
     ...
     */
    def static void isTrue(boolean expression, String errorMessage) {
        if (!expression) {
     ...
     */
    def static void notEmpty(String string, String errorMessage) {
        if (string.isEmpty()) {
            throw new IllegalArgumentException(errorMessage);
        }
    }
     ...
     */
    def static void notNull(Object reference, String errorMessage) {
        if (reference === null) {
